...
from app.api.endpoints import ai, approaches, auth, crm, dashboard, health, leads, messages, settings
...
api_router.include_router(messages.router, prefix="/messages", tags=["messages"], dependencies=[Depends(require_authenticated_user)])
